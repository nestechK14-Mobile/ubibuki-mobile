...
export { default as DetailScreen } from './detail/detailScreen1';
export { default as DetailScreen2 } from './detail/detailScreen2';
export { default as NumberLogin } from './login/number_login';
